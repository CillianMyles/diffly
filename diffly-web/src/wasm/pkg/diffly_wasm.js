/* @ts-self-types="./diffly_wasm.d.ts" */
...
export function diff_csv_bytes_json(a_bytes, b_bytes, key_columns_csv, header_mode, emit_unchanged) {
    ...
    try {
        ...
        const ptr2 = passStringToWasm0(key_columns_csv, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('diffly_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
